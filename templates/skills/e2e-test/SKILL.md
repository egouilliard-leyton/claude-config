---
name: e2e-test
description: End-to-end testing workflow using agent-browser CLI. Researches the app, tests every user journey with screenshots and database validation, fixes issues found, and generates a report. Use when you want to thoroughly validate a web application before code review.
---
